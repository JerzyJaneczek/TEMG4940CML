  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      <AppBar
        position="fixed"
        open={open}
        sx={{ backgroundColor: "main.main", height: "8%" }}
      >
        <Toolbar>
          <IconButton
            color="inherit"
      ...
      <Main open={open} sx={{ backgroundColor: "main.lightest" }}>
        <DrawerHeader />
        ...
        <Typography paragraph>
          This site suits the purpose to keep a log of my own and the groups
          progress in the TEMG4940C project.
        </Typography>
        <Divider></Divider>
        <Typography
          variant="h4"
